...
namespace OpenAccessMySqlSupermarketEntityModel	
{
	public partial class OpenAccessMySqlSupermarketEntityModel : OpenAccessContext, IOpenAccessMySqlSupermarketEntityModelUnitOfWork
	{
		...
		public OpenAccessMySqlSupermarketEntityModel()
			:base(connectionStringName, backend, metadataSource)
		{ }
		
		public OpenAccessMySqlSupermarketEntityModel(string connection)
		...
		public OpenAccessMySqlSupermarketEntityModel(string connection, MetadataSource metadataSource)
			:base(connection, backend, metadataSource)
		{ }
	...
	public interface IOpenAccessMySqlSupermarketEntityModelUnitOfWork : IUnitOfWork
	{
